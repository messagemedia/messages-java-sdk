...
public class RepliesController extends BaseController {
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    StringBuilder _queryBuilder = new StringBuilder("/v1/replies");
                        ...
                        if (getHttpCallBack() != null)
 {
    ...
    public DynamicResponse confirmRepliesAsReceived(
        ...
        confirmRepliesAsReceivedAsync(body, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    //prepare query string for API call
                    StringBuilder _queryBuilder = new StringBuilder("/v1/replies/confirmed");
